...
__PACKAGE__->add_columns(
    "user", { data_type => "integer", is_foreign_key => 1, is_nullable => 0 },
    "role", { data_type => "integer", is_foreign_key => 1, is_nullable => 0 },
);
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:5P1hDpd7zKc+pACdt88uhg
